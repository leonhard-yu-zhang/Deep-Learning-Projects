...
def vgg_like(input_shape, n_classes, base_filters, n_blocks, dense_units, dropout_rate):
    ...
    Parameters:
        input_shape (tuple: 3): input shape of the neural network, e.g. (256,256,3)
    ...
    assert n_blocks > 0, 'Number of blocks has to be at least 1.'   # print a message if the assertion fails

    inputs = tf.keras.Input(input_shape)  # shape=(None, 256, 256, 3)
